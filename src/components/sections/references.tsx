  ...
  return (
    <section className='bg-primary-800' id='referenzen'>
      <div className='mx-auto max-w-7xl border-t-2 border-primary-900 sm:border-t-0 md:grid md:grid-cols-2 md:px-6 lg:px-8'>
        <div className='px-4 pt-12 sm:px-6 md:flex md:flex-col md:border-r md:border-primary-900 md:pl-0 md:pr-10 md:pt-16 lg:pr-16'>
        ...
        <div className='border-0 border-primary-900 px-4 pt-12 sm:px-6 md:border-l md:pl-10 md:pr-0 md:pt-16 lg:pl-16'>
      ...
      <div className='mx-auto max-w-7xl md:grid md:grid-cols-2 md:border-b-2 md:border-primary-900 md:px-6 lg:px-8'>
        <div className='px-4 py-12 sm:px-6 sm:text-right md:flex md:flex-col md:border-r md:border-primary-900 md:py-16 md:pl-0 md:pr-10 lg:pr-16'>
          ...
          <p className='text-lg leading-8 text-green-300'>
            Jazz/Bossa-Nova-Band
          </p>
          <div className='md:flex-shrink-0'>
            <YoutubeEmbed embedId='V7-3ebfHL00' />
          </div>
        </div>
        <div className='border-t-2 border-primary-900 px-4 py-12 sm:px-6 md:border-l md:border-t-0 md:py-16 md:pl-10 md:pr-0 lg:pl-16'>
          <h3 className='mt-2 text-3xl font-extrabold leading-8 tracking-tight text-green-50 sm:text-4xl'>
            Steven Lawrenz
          </h3>
                ...
                <div className='overflow-hidden shadow ring-1 ring-black ring-opacity-5 md:rounded-lg'>
                  <table className='min-w-full divide-y divide-gray-300'>
                    ...
                    <tbody className='divide-y divide-gray-200 bg-white'>
                      {bands.map((band) => (
                        <tr key={band.name}>
                          <td className='whitespace-normal py-2 pl-4 pr-3 text-sm font-medium text-gray-900 sm:whitespace-nowrap sm:pl-6'>
                            {band.name}
                          </td>
                          <td className='whitespace-normal px-3 py-2 text-sm text-gray-500 sm:whitespace-nowrap'>
                            {band.genre}
                          </td>
                        </tr>
                      ))}
